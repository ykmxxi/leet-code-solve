/*
    - n개의 도시가 존재, flights[i] = (from, to, price)
    - src 에서 dst 까지 최대 k 개의 경유 이내의 가장 싼 경로 찾기, 존재하지 않으면 -1
    - 1 <= n <= 100, 주어진 간선의 개수는 (n - 1) * n /2, 자기 자신을 잇는 경로는 없음
    - 두 도시 사이의 간선은 1개만 존재, 출발지와 도착지는 다름
*/
import java.util.*;
